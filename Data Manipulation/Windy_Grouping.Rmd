...
Read in final data
```{r}
data <- read_csv("C:/Users/Bryant Willoughby/Documents/DRUMS/raw(Windy)/Final Data Sets/prefire_windy_finaldata.csv")

```

Process for grouping variables: linear regression
...
dates <- as.Date(c("2021-08-30","2021-08-31","2021-09-01","2021-09-03",
                   "2021-09-04", "2021-09-05", "2021-09-07", "2021-09-09"))
...
```{r}
firedate <- as.Date("2021-09-09")
dates <- as.Date(c("2021-08-30", "2021-09-03", "2021-09-07"))
...
```{r}
firedate <- as.Date("2021-09-09")
dates <- as.Date(c("2021-08-26", "2021-08-30", "2021-09-03", 
                   "2021-09-07"))
...
```{r}
firedate <- as.Date("2021-09-09")
dates <- as.Date(c("2021-08-30", "2021-08-31", "2021-09-01",
                   "2021-09-04", "2021-09-06", "2021-09-09"))
...
```{r}
firedate <- as.Date("2021-09-09")
dates <- as.Date(c("2021-08-28", "2021-08-29", "2021-09-03",
                   "2021-09-05", "2021-09-06", "2021-09-08"))
...
```{r}
firedate <- as.Date("2021-09-09")
dates <- as.Date(c("2021-08-28", "2021-08-29", "2021-08-30",
...
```{r}
write.csv(fulldata, "C:/Users/Bryant Willoughby/Documents/DRUMS/raw(WIndy)/Final Data Sets/prefire_windy_grouped_finaldata.csv", row.names = F)
```
