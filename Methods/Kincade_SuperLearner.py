...
data = pd.read_csv('prefire_kincade_grouped_standard_finaldata.csv')
...
data.to_csv("Kincade_traindata.csv", index=False)
test_df.to_csv("Kincade_testdata.csv", index=False)
