...
```{r}
train <- read_csv("C:/Users/Bryant Willoughby/Documents/DRUMS/raw(CZU)/intermediate/CZU_traindata.csv")

test <- read_csv("C:/Users/Bryant Willoughby/Documents/DRUMS/raw(CZU)/intermediate/CZU_testdata.csv")
```
...
#anova(final_model)
summary(final_model) #about 48.4% of variance explained by model 
...
```{r}
#make dnbr preds 
predicted_values <- predict(final_model, newdata = test[, !(names(test) %in% c("Lat", "Lon", "dnbr", "LC"))])
