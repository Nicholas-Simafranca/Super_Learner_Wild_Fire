...
```{r}
train <- read_csv("C:/Users/Bryant Willoughby/Documents/DRUMS/raw(combined)/combined/combined_standardized_traindata.csv")

test <- read_csv("C:/Users/Bryant Willoughby/Documents/DRUMS/raw(combined)/combined/combined_standardized_testdata.csv")
```
