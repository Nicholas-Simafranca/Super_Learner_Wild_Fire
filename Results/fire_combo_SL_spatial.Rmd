...
Read in Z matrix 
```{r} 
Z <- read_csv("C:\\Users\\Bryant Willoughby\\Documents\\DRUMS\\raw(combined)\\combined\\combined_standardized_NEW_meta_data.csv")
...
Read in Z' matrix
```{r}
Z_prime <- read_csv("C:\\Users\\Bryant Willoughby\\Documents\\DRUMS\\raw(combined)\\combined\\combined_standardized_predicted_fitted_values.csv")
